...
| 16.6 | Box Cockpit ganha visão Engenharia — subscribe canal Realtime `live-stint-{id}`, renderiza na TV 32" via Fire TV Stick 4K Max (navegador → app na nuvem) — (atualizado 16/06/2026 - ver docs/ARQUITETURA_DEFINITIVA.md). Gate: MS-9 + MS-12 fechados | Cloud | ❌ gate |
