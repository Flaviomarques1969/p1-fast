...
| # | Task | Onde |
|---|---|---|
| 13.1 | **Medir a TELA 10,5" externa** (não o notebook) que o piloto vai olhar — resolução nativa, DPR, área útil descontando barra de tarefas. Ajustar viewport do mockup canônico (atual 956×440) pra encaixar landscape nessa tela. Confirmar que rotação 180° está configurada em Windows Display Settings (a tela é montada de cabeça pra baixo no painel — ADR-023 amendment 5). Decisão de produto: full-bleed kiosk vs janela com bordas. | Aqui (Flávio + Claude) |
