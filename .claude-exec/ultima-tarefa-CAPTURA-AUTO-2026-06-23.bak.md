...
---
## Limpeza de cópias paralelas (ambientes isolados) — 23/06/2026
- Removidas (0 commits fora da oficial, sem trabalho solto): busy-gates-d5b23f, treinos-ia-v1, youthful-montalcini-95f35b, manutencao-feedback-visual, plano-stint-banco-v1.
- PRESERVADA mesmo com 0 commits fora: hardcore-napier-a5e10c (tinha arquivos modificados/não rastreados — trava de segurança recusou; preservado de propósito).
- PRESERVADAS por terem commits fora da oficial (trabalho que pode não estar incorporado): determined-beaver-390de9(163), friendly-hopper-b61e0e(152), hardcore-nightingale-d1a1b8(25), infallible-bardeen-dedc29(167), infallible-liskov-7a1b15(159), infallible-snyder-198a08(126), rodada1-s1(14), command-box-mockup-recovery(9), cerebro-nuvem-tripa(3), classificador-trail(92), cockpit-treino-trail(176), revisao-treino-freio(9).
- Método: git worktree remove SEM --force (recusa qualquer cópia suja). Nenhuma linha de trabalho (branch) foi apagada — só a cópia em disco das já incorporadas.
