...
struct StintReadyView: View {
    ...
    private var cabecalho: some View {
        VStack(alignment: .leading, spacing: 6) {
            ...
            Text("Escolha como quer ver durante a corrida e toque START.")
                .font(.system(size: 13, weight: .regular))
                .foregroundStyle(Color.textMuted)
                .padding(.top, 4)
        }
    ...
    private var opcoes: some View {
        VStack(spacing: 12) {
            opcaoCard(
                ...
                hint: "Mostra REC, voltas, IMU, GPS e segmentos. Útil quando o iPhone fica visível pra você operar a captura.",
                modo: .dados
            )
            opcaoCard(
                titulo: "Cockpit do piloto",
                hint: "Mostra velocidade, volta atual, melhor volta e tempo. Útil quando o iPhone está montado na frente do piloto. Os dados continuam sendo capturados normalmente.",
                modo: .cockpit
            )
        }
    }
