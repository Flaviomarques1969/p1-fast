...
struct HubMockLauncher: View {
    ...
    @StateObject private var stintRepo: StintRepository // TEMP-PROVA mapa 22/06 — reverter
    ...
    private func rotaMock(carroId id: String) -> [HomeNavTarget] {
        if ProcessInfo.processInfo.arguments.contains("--p1-melhor") { return [.melhorVolta] } // TEMP-PROVA mapa 22/06 — reverter
        if ProcessInfo.processInfo.arguments.contains("--p1-home-nu") { return [] } // (atalho de prova anterior)
