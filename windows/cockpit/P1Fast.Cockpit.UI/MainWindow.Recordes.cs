...
public sealed partial class MainWindow
{
    ...
    private FileRecordesStore? _recordesStore;
    ...
    private void InicializarRecordes()
    {
        ...
        {
            _recordesStore = new FileRecordesStore();
    ...
    {
        if (_recordes is null || tempoMs <= 0 || double.IsNaN(tempoMs) || double.IsInfinity(tempoMs)) return;
