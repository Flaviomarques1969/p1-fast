...
const prova = {
  ...
  volta_real_projetada_amostra: realGps.filter((_,i)=>i%Math.ceil(realGps.length/120)===0).map(g=>{ const q=geoParaCommandBox(g.lat,g.lng); return [ +q.x.toFixed(1), +q.y.toFixed(1) ]; }),
};
